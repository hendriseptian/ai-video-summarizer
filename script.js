/* ============================================================
   ...
   Supports EN / ID response structure
   ============================================================ */
...
async function exportPDF() {
    ...
    try {
        ...
        for (
            ...
            pdf.text(
                `AI Video Summarizer — Page ${page} of ${pageCount}`,
                15,
                287
            );
